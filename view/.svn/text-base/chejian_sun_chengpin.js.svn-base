...
(function () {
    ...
    var prop = {
        ...
        template_url: 'view/chejian_sun_cailiao.html',
        title: '成品报损登记',
        ...
        quick: { '查看历史报损记录': 'chejian_sun_list' },
        onlyhas: false,//只看已定
        output: 0,
        data:{
        ...
        initData: function (data) {
            ...
            */
            ...
            //初始化列表
            var arr = {};
            var bhistory = !$.isEmptyObject(my.baosun_chengpin);
            $.each(this.data.list, function () {
                ...
                //历史缓存的订单记录
                if (!my.baosun_chengpin.list[this.cInvCode]) return true;
                this.baosun_yuanyin = my.baosun_chengpin.list[this.cInvCode].baosun_yuanyin ;
                this.baosun_num = my.baosun_chengpin.list[this.cInvCode].baosun_num;
                this.goods_type = '临时增加';
            });
            this.data.list = arr;
            if (bhistory) {
                this.data.adddate = my.baosun_chengpin.adddate;
            } else {
        ...
        bindEvent: function () {
            ...
            $("#submit_order").click(function () {//提交订单
                ...
                my.view.showTable('chejian_sun_confirm_chengpin');
            });
    ...
    my.extend(a, prop);
    my.moudle.chejian_sun_chengpin = a;
})();