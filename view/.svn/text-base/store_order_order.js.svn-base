...
(function () {
    ...
    var prop = {
        ...
        template_url: 'view/store_order_order.html',
        title: '申请订货',
        ...
        bindEvent: function () {
            ...
            $("#submit_order").click(function () {
                ...
                my.view.showTable('store_order_confirm');
            });
        ...
        showGoodsListByType: function (type) {
            ...
            var tmplist=[];
            $.each(this.data.list, function (k) {
            ...
            $.each(tmplist,function(){
                ...
                //tr.appendChild(_this.td(this.showorder));
