...
(function () {
    ...
    var prop = {
        ...
        output: 0,
        current_quick: '返回修改',
        quick: { '返回修改': 'chejian_sun_cailiao'},
        real_recv: {},//实收数组
        init: function () {
            this.data = my.baosun;
        },
        ...
        getTableHtml: function () {
            var _this = this;
            return my.order.getContent({order_type:5,chejian_id:my.baosun.current_chejian_id,adddate:my.baosun.adddate}, my.baosun.list, '', ['bianhao', 'name', 'guige', 'kucun_danwei', 'baosun_num', 'baosun_yuanyin'],'确认提交');
        },
        bindEvent: function () {
            var _this = this;
            $(".city_submit").click(function () {
                ...
                my.util.send('order->addNewOrder', {
                    ...
                    current_chejian_id: my.baosun.current_chejian_id
                }, function (data) {
    ...
    my.extend(a, prop);
    my.moudle.chejian_sun_confirm = a;
})();