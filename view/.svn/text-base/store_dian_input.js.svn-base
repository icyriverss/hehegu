...
(function () {
    var a = new my.table();
    var prop = {
        template_url: 'view/store_dian_input.html',
        title: '水电指数录入',
        output: 0,
        data: {},
        selection: 'td',//td选择高亮
        ...
        bindEvent: function () {
            ...
            $("#data .input-submit").bind('click', function () {
                ...
                my.view.load(1);
                my.shuidian.editZhishu({ list: arr, usedate: usedate, store_id: _this.store_id || my.user.info.store_id }, function () {
                    my.view.message('录入成功！', 1, function () {
                        my.view.showTable('store_dian_input');
                    });
                });
            });
        }
