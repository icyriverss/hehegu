...
(function () {
    ...
    var prop = {
        ...
        getTableHtml: function () {
            var _this = this;
            return my.order.getContent({order_type:6,store_id:my.baosun_chengpin.current_store_id,adddate:my.baosun_chengpin.adddate}, my.baosun_chengpin.list, '', ['bianhao', 'name', 'guige', 'kucun_danwei', 'baosun_num', 'baosun_yuanyin'],'确认提交');
        },
        bindEvent: function () {
            var _this = this;
            $(".city_submit").click(function () {
                ...
                my.util.send('order->addNewOrder', {
                    ...
                    current_store_id: my.baosun_chengpin.current_store_id
                }, function (data) {
    ...
    my.extend(a, prop);
    my.moudle.store_sun_confirm_chengpin = a;
})();