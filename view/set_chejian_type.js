...
(function(){
    ...
    var prop = {
        ...
        template_url: 'view/set_chejian_type.html',
        title: '订货分类管理',
        ...
        changeType:function(type){
            ...
            my.view.freshTable('set_chejian_type');
        },
        ...
        showGoodsListByType:function(type){
            var res = '<tr><th width="100">编码</th><th>名称</th><th width="120">规格</th><th width="70">库存单位</th><th width="70">包装单位</th><th width="80">包装换算率</th><th width="80">定额换算率</th><th width="100">操作</th></tr>';
            var _this = this;
            $("#set_order_type_list tr").each(function (i) {
                if (i < 1) return true;
                $(this).remove();
            ...
            $("#set_order_type_list tr .submit_order").click(function () {
                ...
                var tmpobj = this;
                my.view.load(1);
                my.util.send('order->removeType', { id: id, type: _this.current_quick,isstore:2 }, function (data) {
                    my.view.load(0);
        ...
        addType: function () {
            ...
            my.view.load(1);
            my.util.send('order->addType', { name: type_name, isstore: 2 }, function (data) {
                if (data.status == 1) return my.view.message('已存在该分类名称！');
                my.view.message('新增分类成功！', 1, function () {
                    my.view.showTable('set_chejian_type');
                });
            });
        },
        //修改分类名称
        ...
        delType: function () {
            ...
            if (confirm('确定要删除该分类吗？一旦删除将不能恢复！')) {
                ...
                my.util.send('order->delType', {
                    name: this.current_quick, isstore: 2
                }, function (data) {
        ...
        insertTable: function (arr, page) {
            ...
            $("#pro_list .submit_order").click(function () {
                ...
                var tmpobj = this;
                my.view.load(1);
                my.util.send('order->addToType', { id: id, type: _this.current_quick, isstore: 2 }, function (data) {
