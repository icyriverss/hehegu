...
(function () {
    ...
    var prop = {
        ...
        template_url: 'view/chejian_bag_day.html',
        title: '日结盘点登记',
        ...
        quick: { '查看历史盘点记录': 'chejian_bag_list' },
        onlyhas: false,//只看已定
        output: 0,
        data:{
        ...
        bindEvent: function () {
            ...
            $("#submit_order").click(function () {//提交订单
                ...
                my.pandian = {
                    ...
                    chejian_id: _this.data.current_chejian_id,
                    chejian_name: my.chejians[_this.data.current_chejian_id].chejian_name,
                    current_chejian_id: _this.data.current_chejian_id,//当前所在门店
                    adddate: adddate//
                };
                my.view.showTable('chejian_bag_confirm');
            });
