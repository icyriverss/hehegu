...
(function () {
    var a = new my.table();
    var prop = {
        template_url: 'view/chejian_order_confirm.html',
        title: '订货单确认',
        perpage: 10,
        output: 0,
        current_quick: '返回修改订货单',
        quick: { '返回修改订货单': 'chejian_order_order' },
        init: function () {
            var _this = this;
            this.data = my.zongbu;
        ...
        bindEvent: function () {
            ...
            $(".city_submit").click(function () {
                ...
                my.util.send('order->addNewOrder', {
                    ...
                    current_chejian_id: my.zongbu.current_chejian_id
                }, function (data) {
    ...
    my.extend(a, prop);
    my.moudle.chejian_order_confirm = a;
})();